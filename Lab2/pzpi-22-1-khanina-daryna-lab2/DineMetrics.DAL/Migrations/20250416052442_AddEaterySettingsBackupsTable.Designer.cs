...
namespace DineMetrics.DAL.Migrations
{
    ...
    [Migration("20250416052442_AddEaterySettingsBackupsTable")]
    partial class AddEaterySettingsBackupsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DineMetrics.Core.Models.EaterySettingsBackup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EaterySettingsBackups");
                });
            ...
            modelBuilder.Entity("DineMetrics.Core.Models.EaterySettingsBackup", b =>
                {
                    b.HasOne("DineMetrics.Core.Models.Eatery", "Eatery")
                        .WithMany("EaterySettingsBackups")
                        .HasForeignKey("EateryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DineMetrics.Core.Models.Eatery", b =>
                {
                    ...
                    b.Navigation("EaterySettingsBackups");
